  ...
  if (loading) {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="bg-white/80 dark:bg-gray-900/60 rounded-2xl overflow-hidden border border-gray-200 dark:border-white/5">
  ...
  if (!vlogs || vlogs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-32 text-center">
        ...
        <h3 className="text-gray-900 dark:text-white text-2xl font-bold mb-2">No vlogs yet</h3>
